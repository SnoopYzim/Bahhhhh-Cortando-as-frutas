...
let knife,fruit ,monster,fruitGroup,monsterGroup, score,r,randomFruit, position;
let knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage;

 let somdemorte, somdecorte;
...
function preload(){
  ...
  //carregue o som aqui
  somdemorte = loadSound("gameover.mp3");
  somdecorte = loadSound("KnifeSwoosh.mp3");
}
...
function setup() {
  ...
  // variaveis de pontuação e grupos
  score=0;
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    if(fruitGroup.isTouching(knife)){
      ...
      // adicione o som de KnifeSwoosh aqui
      somdecorte.play();
      score = +2
    }
    else
...
function fruits(){
  if(World.frameCount%80===0){
    ...
    fruit=createSprite(400,200,20,20);
     ...
     //usar uma letiável aleatória para mudar a posição da fruta e tornar mais desafiador
